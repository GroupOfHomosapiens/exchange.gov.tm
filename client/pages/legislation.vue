  ...
  <v-container>
    ...
    <div>
                ...
                <v-timeline-item>
                  ...
                  >
                    <v-card-text class="white text--primary">
                      <h2>
                        <center class="primary--text pb-5 pt-2">
                          {{ $t('consularLegalizationText3') }}
                        </center>
                      </h2>
      ...
      <div class="primary my-5 darken-2 mx-n2">
        <div>
          <h1>
            <center class="white--text darken-5 py-5">
              {{ $t('ratesAndFess') }}
            </center>
          </h1>
          <h4 style="color: #eee;">
            <center class="py-2">
              {{ $t('tariffsForservices') }}
            </center>
          </h4>
        </div>
        <v-row>
...
import Waved from '@/components/Waved.vue'
